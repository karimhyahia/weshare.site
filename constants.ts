...
export const INITIAL_DATA: CardData = {
  ...
  collectedContacts: [
      { id: '1', name: 'John Doe', email: 'john@example.com', phone: '555-1234', date: '2023-10-24' },
      { id: '2', name: 'Sarah Smith', email: 'sarah@studio.design', phone: '555-5678', date: '2023-10-25' },
  ],
  themeId: 'ocean',
  font: FontType.SANS,
  qrColor: '#0f172a',
